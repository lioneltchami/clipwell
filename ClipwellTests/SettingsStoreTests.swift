...
struct SettingsStoreTests {
    ...
    @Test func defaultShowClipwellIsFalse() {
        let store = makeStore()
        #expect(store.showClipwell == false)
    }
    ...
    @Test func generateFilenameFormat() {
        ...
        #expect(filename.hasPrefix("Clipwell_"))
    ...
    @Test func defaultOutputDirectoryIsMoviesClipwell() {
        let store = makeStore()
        let expected = URL.homeDirectory.appending(path: "Movies/Clipwell")
