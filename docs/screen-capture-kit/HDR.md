...
For general HDR concepts, see [concepts/VIDEO.md](../concepts/VIDEO.md). For Clipwell-specific output settings, see [architecture/OUTPUT.md](../architecture/OUTPUT.md).
