...
This document outlines the manual testing matrix for Clipwell. These tests focus on hardware interactions, visual verification, and edge cases that are difficult to automate.
