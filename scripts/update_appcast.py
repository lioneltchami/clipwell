"""
Update the appcast.xml file for Clipwell releases.
...
Sparkle clients can fetch it from a stable URL:
    https://github.com/lioneltchami/clipwell/releases/latest/download/appcast.xml
...
repo_url = "https://github.com/lioneltchami/clipwell"
...
if et is None:
    root = ET.fromstring(
        ...
        "<channel>"
        "<title>Clipwell Updates</title>"
        "<link>https://github.com/lioneltchami/clipwell/releases/latest/download/appcast.xml</link>"
        "<description>Updates for Clipwell</description>"
