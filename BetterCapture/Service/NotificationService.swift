...
final class NotificationService: NSObject {
    ...
    /// Sends a brief countdown notification before recording starts.
    func sendCountdownNotification(remaining: Int) {
        send(
            title: "Recording starts in \(remaining)...",
            body: "Get ready.",
            category: NotificationIdentifier.categoryRecordingFailed
        )
    }

    func sendPauseStateNotification(paused: Bool) {
        send(
            title: paused ? "Recording Paused" : "Recording Resumed",
            body: paused ? "Capture is paused." : "Capture continues.",
            category: NotificationIdentifier.categoryRecordingFailed
        )
    }
